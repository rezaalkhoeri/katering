	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo base_url('/home.html') ?>">
				<img width="50" style="margin-top: -13px;" alt="Brand" src="<?php echo base_url('/asset/img/vischa-logo.png') ?>">
			</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<?php } ?>
				<li><a id="nav-menu" target="_blank" href="https://wa.me/6282325305037/?text=Halo admin Vicha Katering. Saya tertarik untuk pesan katering disini.">Kontak Kami</a></li>
				<li>
